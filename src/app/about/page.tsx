      ...
      <header className="flex flex-col md:flex-row items-center gap-8 md:gap-12 py-16 text-center md:text-left">
        ...
        <div>
          ...
          <p className="mt-2 text-xl md:text-2xl text-primary font-semibold">
            ...
            <span className="whitespace-nowrap">C#, Python & TypeScript</span> |{" "}
            <span className="whitespace-nowrap">
              Passionate about AI-Driven Problem-Solving and DevOps
            </span>
          </p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <Button asChild size="lg" variant="outline">
              <a
                ...
                download="Kingsley_Leung_Academic_Transcript.pdf"
              >
                <Download className="mr-2 h-4 w-4" />
                Download Transcript
              </a>
      ...
      <Section>
        ...
        <div className="space-y-8 relative before:absolute before:inset-y-0 before:left-0 before:h-full before:w-0.5 before:bg-border before:opacity-50">
          {workExperience.map((job, index) => (
            <Card
              key={index}
              className="pl-8 relative before:absolute before:left-[-2px] before:top-9 before:h-0.5 before:w-4 before:bg-primary"
            >
              <CardHeader>
              ...
              <CardContent>
                <ul className="mb-4 list-disc pl-5 space-y-1 text-muted-foreground">
                  {Array.isArray(award.description) ? (
                    award.description.map((item, i) => <li key={i}>{item}</li>)
                  ) : (
